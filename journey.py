...
def _derive_bpmn_feedback(events: Sequence[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    for event in events:
        ...
        if not normalized_issue:
            lowered = aggregate_text
            if "fehlendes gateway" in lowered or "missing gateway" in lowered:
                normalized_issue = "missing_gateway"
            elif ("fehlerbehandlung" in lowered and ("falsch" in lowered or "fehl" in lowered)) or (
                "escalation" in lowered and ("fehl" in lowered or "unhandled" in lowered)
            ) or ("eskalation" in lowered and "fehl" in lowered):
                normalized_issue = "incorrect_error_handling"
